  ...
  pinoHttp({
    ...
    redact: {
      paths: [
        ...
        "body.messages",
        "body.prompt",
		"req.url" // Redact url cause of query ?key= for google api will need to fix it otherwise / don't log what is not supposed to be logged ig (will worry about censoring only google one later)
      ],
      censor: "********",
    },
  })
