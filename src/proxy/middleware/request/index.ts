...
//export { addGooglePreamble } from "./add-google-preamble";
export { addImageFromPromptGemini } from "./add-image-prompt";
 ...
 */
export type RequestPreprocessor = (req: Request, res: Response) => void | Promise<void>;
